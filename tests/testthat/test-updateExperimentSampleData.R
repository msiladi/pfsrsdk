...
test_that(paste("test updateExperimentSampleData() on: ", env$auth), {
  ...
  result <- updateExperimentSampleData(con$coreApi, data$experimentAssayType, data$experimentSampleBarcode, data$experimentAssayUpdateAttrList, useVerbose = verbose)
